...
RSpec.describe Consumption, type: :system do
  describe '消費一覽' do
    before do
      10.times do |n|
        ...
        FactoryBot.create(:consumption, tag: tag)
      end
    ...
    context '最新五筆消費' do
      ...
      it 'have recent 5 consumptions' do
  ...
  describe '編輯消費' do
    ...
    let!(:consumption) { FactoryBot.create(:consumption, tag: tag_1) }
  ...
  describe '刪除消費' do
    ...
    before do
      FactoryBot.create(:consumption, tag: tag_1)
    end
